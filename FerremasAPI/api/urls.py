...
urlpatterns=[
    ...
    path('api/compras-por-venta/', views.BuscarComprasVentaAPI.as_view(), name='compras-por-venta'),
    ...
    path('api/crear-detalle-comprado/', views.CrearDetalleCompradoAPI.as_view(), name='crear-detalle-comprado'),
